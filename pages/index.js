...
export default function Home() {
        ...
        <div className="relative h-[70vh]">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="text-center text-white max-w-3xl mx-auto px-4">
              ...
              <p className="text-xl font-light">נולד בבת ים, בכ"ו בסיון תשמ"א</p>
            </div>
          </div>
        </div>
  ...
  <div className="bg-white/90 backdrop-blur-sm p-10 rounded-2xl shadow-lg flex flex-col items-center">
    <h2 className="text-3xl font-semibold mb-6 text-red-700">וידאו</h2>
    {/* כאן תוסיף את המוזיקה */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700">נולד בבת ים</p>
  ...
  />
                  ...
                  <div>
                    ...
                    <p className="text-gray-700"> הורים אח ואחות שנולדה אחרי נפילתו</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm p-10 rounded-2xl shadow-lg">
              <div className="flex flex-col md:flex-row md:items-start gap-8">
                ...
                <div className="flex-shrink-0 mb-6 md:mb-0 md:ml-8 w-full md:w-64">
  <Image
    src="/images/6991698296379640360no.jpg"
    alt="חיים בכר ז״ל - פורטרט"
    width={300}
    height={400}
    className="rounded-2xl object-cover shadow-md w-full h-auto mb-64"
    priority
  />
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-2xl font-semibold text-red-700">אישיותו</h3>
                    </div>
                    <p className="text-gray-700 leading-relaxed text-lg">
